...
if(process.env.NODE_ENV === 'staging') {
    ...
    mongoose.connect("mongodb+srv://"+DB_USERNAME+":"+DB_PASSWORD+"@"+DB_URL, {
...
mongoose.connect("mongodb+srv://phalguni:phalguni@cluster0.vyqlb.mongodb.net/phalguni?retryWrites=true&w=majority", {
   ...
   useUnifiedTopology: true
    ...
    if(error){
        ...
        console.log("Server has been coonected to mongodb")
    };
});
};
...
app.listen(PORT, function() {
	console.log("Application has started in environment and running on port: ", PORT);
